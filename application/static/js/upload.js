class upload{
  constructor(){
    ...
    this.filename="file";
    this.selectBtnStyle="width:150px;height:30px;border-radius:5px;background:#46b8da;line-height:30px;";
    this.selectBtnCon="请选择";

    this.upBtnStyle="width:150px;height:30px;border-radius:5px;background:#ccc;clear:both;line-height:30px;"
    this.upBtnCon="点击上传";
 ...
 createSelect(parent,selectBtn,callback){
     ...
     selectBox.style.lineHeight=30+"px"
     callback();
