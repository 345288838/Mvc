...
class code{
    ...
    function __construct()
    {
        ...
        $this->width=$config["code"]["width"]?$config["code"]["width"]:130;
        $this->height=$config["code"]["height"]?$config["code"]["height"]:40.63;
        $this->codeLen=$config["code"]["codeLen"]?$config["code"]["codeLen"]:4;
        $this->seed=$config["code"]["seed"]?$config["code"]["seed"]:"abcdefhjkmnprstuvwxyzABCDEFGHJKMNPQRSTUVWXYZ2345678";
        ...
        $this->pixNum=$config["code"]["pixNum"]?$config["code"]["pixNum"]:array("min"=>50,"max"=>80);
        $this->fontFile=$config["code"]["fontFile"]?$config["code"]["fontFile"]:"D:\WampSever\www\\2006\mvc\application\static/font/demo.TTF";
    }
    ...
    private function setPix(){
        $num=mt_rand($this->pixNum["min"],$this->pixNum["min"]);
        for($i=0;$i<$num;$i++){
